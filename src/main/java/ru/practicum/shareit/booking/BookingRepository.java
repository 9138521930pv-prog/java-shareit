...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    ...
    List<Booking> findByBooker_IdAndStatus(Integer userId, Status bookingStatus, Sort sort);
    ...
    List<Booking> findByItemOwnerIdAndStatus(Integer itemOwnerId, Status bookingStatus, Sort sort);
